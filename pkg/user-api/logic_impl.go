...
func (l *UserAPILogic) CreateUser(req models.CreateUser) (models.CreateUserResponse, error) {
	...
	if err == repo.ErrForeignKeyViolation {
		return models.CreateUserResponse{}, errInvalidRole
	}

	if err == repo.ErrUniqueViolation {
		return models.CreateUserResponse{}, errUserAlreadyCreated
	}
